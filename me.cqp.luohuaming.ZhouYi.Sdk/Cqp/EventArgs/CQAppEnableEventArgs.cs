...
namespace me.cqp.luohuaming.ZhouYi.Sdk.Cqp.EventArgs
{
	...
	/// Type: 1003
	/// </summary>
	public sealed class CQAppEnableEventArgs : CQEventEventArgs
	{
		#region --构造函数--
		/// <summary>
		...
		public CQAppEnableEventArgs (CQApi api, CQLog log, int id, int type, string name, string function, uint priority)
