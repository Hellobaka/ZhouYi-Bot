using me.cqp.luohuaming.ZhouYi.Tool.IniConfig.Attribute;
using me.cqp.luohuaming.ZhouYi.Tool.IniConfig.Exception;
using me.cqp.luohuaming.ZhouYi.Tool.IniConfig.Linq;
using System;
...
namespace me.cqp.luohuaming.ZhouYi.Tool.IniConfig
{
	/// <summary>
